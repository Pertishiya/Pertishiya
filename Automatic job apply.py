...
chrome_driver_path = rf"C:\Users\perti\Downloads\chrome-headless-shell-win64\chrome-headless-shell-win64\chrome-headless-shell.exe"

# Optional - Automatically keep your chromedriver up to date.
from webdriver_manager.chrome import ChromeDriverManager  # pip install webdriver-manager
#chrome_driver_path = ChromeDriverManager(path=rf"E:\Handson\Chrome Driver").install()
